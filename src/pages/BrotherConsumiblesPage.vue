    ...
    <v-container class="mt-8">
      ...
      <v-row class="mb-6 align-center">
        <v-col cols="12" md="6">
          <v-text-field
            ...
            density="comfortable"
            hide-details
            label="Buscar por modelo o compatibilidad..."
      ...
      <v-row v-else class="justify-center py-12">
        <v-col class="text-center" cols="12" md="6">
          ...
          <h3 class="text-h5 font-weight-bold text-grey-darken-2 mb-2">No se encontraron consumibles</h3>
...
<script setup lang="ts">
  ...
  onMounted(() => {
    document.title = 'Brother Consumibles | Imax PC'
  })

  const filteredProducts = computed(() => {
    return offersStore.brotherConsumibles.filter(product => {
