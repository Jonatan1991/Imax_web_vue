    ...
    <v-container class="mt-8">
      ...
      <v-row v-else class="justify-center py-12">
        <v-col class="text-center" cols="12" md="6">
          ...
          <h3 class="text-h5 font-weight-bold text-grey-darken-2 mb-2">No se encontraron impresoras HP</h3>
...
<script setup lang="ts">
  ...
  onMounted(() => {
    document.title = 'HP Impresoras | Imax PC'
  })

  const filteredProducts = computed(() => {
    return offersStore.hpPrinters.filter(product => {
