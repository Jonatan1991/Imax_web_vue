...
<template>
  <v-sheet id="solutions-section" class="py-16 bg-white">
    <v-container>
      <!-- Cabecera de la Sección -->
      <v-row class="text-center mb-12" justify="center">
      ...
      <v-row class="mt-4" justify="center">
        ...
        >
          ...
          >
            ...
            >
              <span>Saber más</span>
              <v-icon class="ms-1 arrow-icon" size="16">mdi-chevron-right</v-icon>
            </div>
          </v-card>
        </v-col>
      </v-row>
